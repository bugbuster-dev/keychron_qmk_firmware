...
│   ├── sram_sticky_combo.py # Interactive SRAM pipeline module harness
...
The interactive workflow for testing the compiled SRAM pipeline module is:
...
`qmk-tools/qmk/QMKata/module_examples/pipeline_sticky_combo/`, applies
...
- `keyboards/keychron/common/module/pipeline_env.c` — `env->xprintf`
